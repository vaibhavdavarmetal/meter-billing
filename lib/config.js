...
export const PROPERTIES = {
  home: {
    ...
    rate: 9,               // ₹ per unit
    tenants: [
      { slug: "home-first",    name: "First Floor",  rent: 0 },
      { slug: "home-second",   name: "Second Floor", rent: 0 },
      { slug: "home-basement", name: "Basement",     rent: 0 },
    ],
  },
  rental: {
    name: "Malibu",
    ...
    tenants: [
      { slug: "rent-1", name: "Tenant 1", rent: 0 },
      { slug: "rent-2", name: "Tenant 2", rent: 0 },
      { slug: "rent-3", name: "Tenant 3", rent: 0 },
      { slug: "rent-4", name: "Tenant 4", rent: 0 },
      { slug: "rent-5", name: "Tenant 5", rent: 0 },
    ],
  },
  ...
  test: {
    ...
    tenants: [
      { slug: "test-tenant", name: "Test Tenant", rent: 0 },
    ],
  },
};
